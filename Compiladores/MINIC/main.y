...
prop : WHILE '(' {$$ = cx + 1;} expr ')'
{genCodigo(SALTARF,$4,0,-1); /* Destino no resuelto */
$$ = cx; /* Falta llenar
cuarto componente de este salto */}
prop {genCodigo(SALTAR,0,0,$3); /*
Ir al comienzo de la expresión */
TABCOD[$6].a3 = cx + 1; /*
Llenando destino de sltar
falso */
};
prop : FOR '(' expr ';' expr ';' expr ')' prop ;
prop : IMPRINUM '(' /*FORMATO { $$ = nTS;
IS(FORMATO,0);}
','*/ expr ')' {genCodigo(IMPRINUM,$3,0,0);};
prop : expr ;
expr : expr OR expr {int n = genvartemp();
genCodigo(OR,n,$1,$3);$$=n;};
expr : expr AND expr {int n = genvartemp();
genCodigo(AND,n,$1,$3);$$=n;};
expr : NOT expr {int n = genvartemp();
genCodigo(NOT,n,$2,-1);$$=n;};
expr : expr IGUAL expr {int n = genvartemp();
genCodigo(IGUAL,n,$1,$3);$$=n;};
expr : expr NOIGUAL expr {int n = genvartemp();
genCodigo(NOIGUAL,n,$1,$3);$$=n;};
expr : expr '<' expr {int n = genvartemp();
genCodigo(MENOR,n,$1,$3);$$=n;}; /* n = $1 < $3 */
expr : expr '>' expr {int n = genvartemp();
genCodigo(MAYOR,n,$1,$3);$$=n;}; /* n = $1 > $3 */
expr : expr MENORIGUAL expr {int n = genvartemp();
genCodigo(MENORIGUAL,n,$1,$3);$$=n;};
expr : expr MAYORIGUAL expr {int n = genvartemp();
genCodigo(MAYORIGUAL,n,$1,$3);$$=n;};
expr : expr '+' expr {int n = genvartemp();
genCodigo(SUMAR,n,$1,$3);$$=n;};
expr : expr '-' expr {int n = genvartemp();
genCodigo(RESTAR,n,$1,$3);$$=n;};
expr : expr '*' expr {int n = genvartemp();
genCodigo(MULT,n,$1,$3);$$=n;};
expr : expr '/' expr {int n = genvartemp();
genCodigo(DIV,n,$1,$3);$$=n;};
expr : expr '?' expr ':' expr ;
expr : ID {$$ = localizaSimbolo(lexema);};
expr : NUM {IS($1,NUM);$$ =
localizaSimbolo(lexema);TS[$$].a3.entero = atoi(lexema);}; /*
Codigo 1 */
expr : REAL {float v;
...
switch(op)
{
case SUMAR: printf("SUMAR %s = %s +
%s\n",TS[a1].nombre,TS[a2].nombre,TS[a3].nombre);break;
case RESTAR: printf("RESTAR %s = %s -
%s\n",TS[a1].nombre,TS[a2].nombre,TS[a3].nombre);break;
case MULT: printf("MULT %s = %s *
%s\n",TS[a1].nombre,TS[a2].nombre,TS[a3].nombre);break;
case DIV: printf("DIV %s = %s /
%s\n",TS[a1].nombre,TS[a2].nombre,TS[a3].nombre);break;
case MENOR: printf("MENOR %s = %s <
%s\n",TS[a1].nombre,TS[a2].nombre,TS[a3].nombre);break;
case MAYOR: printf("MAYOR %s = %s >
%s\n",TS[a1].nombre,TS[a2].nombre,TS[a3].nombre);break;
case MAYORIGUAL: printf("MAYORIGUAL %s = %s >=
%s\n",TS[a1].nombre,TS[a2].nombre,TS[a3].nombre);break;
case MENORIGUAL: printf("MENORIGUAL %s = %s <=
%s\n",TS[a1].nombre,TS[a2].nombre,TS[a3].nombre);break;
...
\n",TS[a1].nombre);break;
case AND: printf("AND %s = %s &&
%s\n",TS[a1].nombre,TS[a2].nombre,TS[a3].nombre);break;
case OR: printf("OR %s = %s ||
%s\n",TS[a1].nombre,TS[a2].nombre,TS[a3].nombre);break;
case NOT: printf("OR %s = %s !
%s\n",TS[a1].nombre,TS[a2].nombre);break;
case IGUAL: printf("AND %s = %s ==
%s\n",TS[a1].nombre,TS[a2].nombre,TS[a3].nombre);break;
case NOIGUAL: printf("AND %s = %s !=
%s\n",TS[a1].nombre,TS[a2].nombre,TS[a3].nombre);break;
// Los demás casos
}
}
...
case SALTARF : if(TS[a1].a3.entero==0) { icx = a3;
continue;} else break;
case SALTARV : if(TS[a1].a3.entero==1) { icx = a3;
continue;} else break;
case IMPRINUM : printf("%8.2f\n",TS[a1].a3.real); break;
case MOVER : TS[a1].a3.real = TS[a2].a3.real; break;
case SUMAR : TS[a1].a3.real = TS[a2].a3.real +
TS[a3].a3.real; break;
case RESTAR: TS[a1].a3.real = TS[a2].a3.real -
TS[a3].a3.real; break;
case MULT : TS[a1].a3.real = TS[a2].a3.real *
TS[a3].a3.real; break;
case DIV : TS[a1].a3.real = TS[a2].a3.real /
TS[a3].a3.real; break;
case MENOR : TS[a1].a3.entero = (TS[a2].a3.real <
TS[a3].a3.real); TS[a1].a3.real = (TS[a2].a3.real <
TS[a3].a3.real);break;
case MAYOR : TS[a1].a3.entero = (TS[a2].a3.real >
TS[a3].a3.real); TS[a1].a3.real = (TS[a2].a3.real >
TS[a3].a3.real);
case AND : TS[a1].a3.entero = (TS[a2].a3.real &&
TS[a3].a3.real); TS[a1].a3.real = (TS[a2].a3.real &&
TS[a3].a3.real);break;
case OR : TS[a1].a3.entero = (TS[a2].a3.real ||
TS[a3].a3.real); TS[a1].a3.real = (TS[a2].a3.real ||
TS[a3].a3.real);break;
case NOT : TS[a1].a3.entero = !(TS[a2].a3.real);
TS[a1].a3.real = !(TS[a2].a3.real); break;
case IGUAL : TS[a1].a3.entero = (TS[a2].a3.real ==
TS[a3].a3.real); TS[a1].a3.real = (TS[a2].a3.real ==
TS[a3].a3.real);break;
case NOIGUAL: TS[a1].a3.entero = (TS[a2].a3.real !=
TS[a3].a3.real); TS[a1].a3.real = (TS[a2].a3.real !=
TS[a3].a3.real);break;
case MAYORIGUAL : TS[a1].a3.entero = (TS[a2].a3.real >=
TS[a3].a3.real); TS[a1].a3.real = (TS[a2].a3.real >=
TS[a3].a3.real);break;
case MENORIGUAL : TS[a1].a3.entero = (TS[a2].a3.real <=
TS[a3].a3.real); TS[a1].a3.real = (TS[a2].a3.real <=
TS[a3].a3.real);break;
}
icx++;
